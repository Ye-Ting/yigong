...
<div class='row'>
  ...
  <div class='col-md-3 col-side'><side class='page-side'><div class='panel-pure panel'><?php echo html::a(helper::createLink('rss', 'index', '?type=activity', '', 'xml'), "<i class='icon-rss text-warning'></i> " . $lang->activity->subscribe, "target='_blank' class='btn btn-lg btn-block'"); ?></div><?php $this->block->printRegion($layouts, 'activity_view', 'side');?></side></div>
</div>
