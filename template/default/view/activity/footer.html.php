<?php
/**
 * The footer view file of activity module of chanzhiEPS.
 *
...
?>
  ...
  <footer id='footer'>
    <div class='wrapper'>
      <div id='footNav'>
        <?php echo html::a(helper::createLink('rss', 'index', '', '', 'xml') . '?type=activity', '<i class="icon icon-rss-sign icon-large"></i>', "target='_blank'"); ?>
      </div>
      <span id='copyright'>
        <?php
